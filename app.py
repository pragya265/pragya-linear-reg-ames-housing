...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        html.Div([
                ...
                html.Div('Kitchen:'),
                dcc.Input(id='KitchenAbvGr', value=0, type='number', min=0, max=3, step=1),
    ...
    html.Div('Predicted Price = (- $1,360.5K Baseline) + ($0.7K * Year Built) + ($12.7K * Bathrooms) + (- $7.7K * Bedrooms) + ($0.049K * Total Square Feet) + ($ 25.2K * Single Family Home) + ($8.6 K * Kitchen)'),
    html.Br(),
